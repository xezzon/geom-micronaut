...
import static io.github.xezzon.geom.group.domain.GroupMember.GROUP_ID;
import static io.github.xezzon.geom.group.domain.GroupMember.USER_ID;
...
public class GroupMember extends BaseEntity<String> {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof GroupMember that)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
